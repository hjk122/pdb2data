% Template of New Molecule 
 ...
 fprintf('\t# Template molecules\n');
    ...
    atoms_num = 3;      % atoms number in the new molecule
    bonds_num = 2;
    angles_num = 1；
    atom_types = 2;     % atom types in water molecule
    bond_types = 1;
    angle_types = 1;
    % Force field 
    % name| epsilon(KJ/mol) | sigma(A) | mass/m | charge/q
    pair_coeffs = { 'H'  0.0000 0.000 1.00794 0.417000 ; % H 
                     'O' 0.6502 3.169 15.9994 -0.83400 ; % O}; 
